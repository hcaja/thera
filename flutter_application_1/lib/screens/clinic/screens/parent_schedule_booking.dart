...
class ParentScheduleBooking extends StatefulWidget {
  const ParentScheduleBooking({super.key, required this.timeData});
  final ParentTimeData timeData;

  @override
  State<ParentScheduleBooking> createState() => _ParentScheduleBookingState();
}

class _ParentScheduleBookingState extends State<ParentScheduleBooking> {
  late Parent parent;
